...
for lg in 0.03 0.1 0.3; do for s in 0 1 2; do run hierarchical_equality 1 $lg $s; done; done
for lg in 0 0.01; do for s in 0 1 2; do run hierarchical_equality 2 $lg $s; done; done
echo TOY_DONE_node0 >> experiments/logs/gates_toy_status.log
